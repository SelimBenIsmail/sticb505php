...
<?php ?>
    ...
    <div class="container" style="margin-top: 1%;">
        <div class="row justify-content-md-center">
            <div class="col-1"></div>
            <div class="col-auto">
                <h5 style="text-decoration:underline"> Analyse des données statistique de l'ONE</h5>
            </div>
            <div class="col-1"></div>
        </div>
        <div class="row justify-content-md-center">
            ...
            <div class="col">
                <div class="jumbotron">
                    ...
                    <hr>
                    <p> Nombre camps organisés cette année : <?php echo "" ?> </p>
                    <p> Frais moyen par personne : <?php echo number_format(getAveragePrice($id_federation),2,","," ")."€" ?></p>
                    <p> Total de subsides occtroyés cette année :<?php echo "" ?></p>
            ...
            <div class="col">
                <div class="jumbotron">
                    ...
                    <hr>
                    <p> Nombre camps organisés cette année : <?php echo "" ?></p>
                    <p> Frais moyen par personne : <?php echo "" ?> </p>
                    <p> Total de subsides occtroyés cette année :<?php echo "" ?> </p>
